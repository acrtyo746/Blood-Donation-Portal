      ...
      <div class="container">
        ...
        <nav class="navbar container" data-navbar>
          <ul class="navbar-list">
            ...
            <li>
              <a href="findDonorlist.html" class="navbar-link" data-nav-link>Find donor</a>
            </li>
            <li>
    ...
    <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')"
        ...
        <div class="container">
          <div class="hero-content">
            ...
            <p class="section-subtitle">Blood Portal</p>
            <h1 class="h1 hero-title">Contact Us</h1>
            <h2 style="color: var(--royal-blue-light);">Address</h2>
            <p class="hero-text">
            Blood_Donation_Drive_Portal, Vashi Road, Near Thalook Headquarters<br>
            Navi Mumbai, Mumbai, IN<br>
            Pin 400043
            </p>
            <h2 style="color: var(--royal-blue-light);">Contact Details</h2>
            <p class="hero-text">
            MOBILE: +91 8828739678 | TELEPHONE: +022 8828739678<br>
            EMAIL : Blood_Donation_Drive_Portal001@gmail.com<br>
            </p>
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d120674.17376794344!2d73.0099328!3d19.0607507!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c103c7ce43a3%3A0x69f659550813b6f8!2sChemist%20Blood%20Bank!5e0!3m2!1sen!2sus!4v1728012072551!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </figure>
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="tel:+918828739678" class="footer-link">+91-8828739678</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:help@example.com" class="footer-link">BloodPortal001@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
